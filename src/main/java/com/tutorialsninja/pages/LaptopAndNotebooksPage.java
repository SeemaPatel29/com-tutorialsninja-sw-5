...
public class LaptopAndNotebooksPage extends Utility {
    ...
    public void sortByPriceHightoLow() {
        CustomListeners.test.log(Status.PASS, "Sort by price High to Low" );
    ...
    public String getMacbookNameText() {
        CustomListeners.test.log(Status.PASS, "Get Macbook name text" );
        Reporter.log("Get Macbook name text" + macbooknameText.toString());
        return getTextFromElement(macbooknameText);
    }

    public void clearQty() {
        CustomListeners.test.log(Status.PASS, "Clear Qty" );
